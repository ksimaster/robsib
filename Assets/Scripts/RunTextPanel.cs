...
public class RunTextPanel : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        "Алена говорит, что ты очень классный! Когда не храпишь, не пердишь и не дрыгаешь ножкой от холода! Так что держись!"
     };
        ...
        "Ты испек на пирожков, Михалыч! Нет? А мы тебе везем! Жди!",
